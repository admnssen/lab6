...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.companyname.appahmetova\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [26 x i8] c"libaot-AppAhmetova.dll.so\00", align 1
