...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001a6b, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001a6a, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x02fb1f87937c47d4, ; from name: aot-AppAhmetova.so
		i64 u0xf51e10259b69c37f, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AppAhmetova.dll.so
		ptr null; void* handle
	}, ; 8
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x03339b8e2ad59b11, ; from name: AppAhmetova
		i64 u0xf51e10259b69c37f, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AppAhmetova.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x142a1963cf1d5c2e, ; from name: aot-AppAhmetova.dll.so
		i64 u0xf51e10259b69c37f, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AppAhmetova.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7fb1c90e188888e2, ; from name: aot-AppAhmetova
		i64 u0xf51e10259b69c37f, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AppAhmetova.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x86316953b466df72, ; from name: AppAhmetova.so
		i64 u0xf51e10259b69c37f, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AppAhmetova.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xaaebcfbb75b8019e, ; from name: AppAhmetova.dll.so
		i64 u0xf51e10259b69c37f, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AppAhmetova.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd5e0f6412ad3daa3, ; from name: libaot-AppAhmetova.so
		i64 u0xf51e10259b69c37f, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AppAhmetova.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xdab5ae9ea0a4d638, ; from name: libaot-AppAhmetova
		i64 u0xf51e10259b69c37f, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AppAhmetova.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf51e10259b69c37f, ; from name: libaot-AppAhmetova.dll.so
		i64 u0xf51e10259b69c37f, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AppAhmetova.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.companyname.appahmetova\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [26 x i8] c"libaot-AppAhmetova.dll.so\00", align 16
